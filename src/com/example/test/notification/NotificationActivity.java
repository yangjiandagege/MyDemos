        ...
        public void onClick(View v) {
            switch(v.getId()) {
                case R.id.le10bt01:
                    ...
                    //第四个参数：点击该通知时执行页面跳转
                    baseNF.setLatestEventInfo(NotificationActivity.this, "Title01", "Content01", pd);
                ...
                case R.id.le10bt02:
                    ...
                    baseNF.setLatestEventInfo(NotificationActivity.this, "Title02", "Content02", pd);
                    nm.notify(Notification_ID_BASE, baseNF);
                    break;
                ...
                case R.id.le10bt04:
                    ...
                    mediaNF.vibrate = vir;
                    mediaNF.setLatestEventInfo(NotificationActivity.this, "Title03", "Content03", pd);
